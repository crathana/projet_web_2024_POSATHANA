...
INSERT INTO Objets (nom, chemin_image, coordonnees, largeur, hauteur, niveau_zoom) 
VALUES ('avion', 'images/cdg.png', ST_SetSRID(ST_MakePoint(-0.48396404445657826, 39.489219807054525), 4326), 125, 125, 13);
...
INSERT INTO Objets (nom, chemin_image, coordonnees, largeur, hauteur, niveau_zoom) 
VALUES ('franceflag', 'images/franceflag.png', ST_SetSRID(ST_MakePoint(-0.4885363124791955, 39.48486293375731 ), 4326), 100, 100, 12);

INSERT INTO Objets (nom, chemin_image, coordonnees, largeur, hauteur, niveau_zoom) 
VALUES ('cambodgeflag', 'images/cambodgeflag.png', ST_SetSRID(ST_MakePoint(-0.4769363124791955, 39.48486293375731 ), 4326), 100, 100, 12);
